...
from suda_ir.query_expansion import DOMAIN_SYNONYMS
from suda_ir.query_intent import PAPER_TERMS, QueryIntent
...
def should_use_semantic(
    ...
    *,
    ...
    """Conservative gate for optional BGE recall inside optimized search."""
